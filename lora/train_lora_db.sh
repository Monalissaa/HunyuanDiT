...
task_flag="lora_dog_db_lora_ema_rank64"                             # task flag
resume_module_root=./ckpts/t2i/model/pytorch_model_ema.pt      # resume checkpoint  # origin: pytorch_model_distill.pt
...
PYTHONPATH=./ deepspeed hydit/train_deepspeed_db_lora.py \
    --task-flag ${task_flag} \
    --model ${model} \
    --training-parts lora \
    --rank ${rank} \
